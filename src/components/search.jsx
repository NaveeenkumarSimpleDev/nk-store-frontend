  ...
  return (
    <>
      <div
        ...
        className="flex gap-4 transition delay-100 ease-in-out  hover:bg-accent items-center bg-white rounded-md xl:py-1.5 py-2 px-3 cursor-pointer border border-gray-100 shadow-sm"
      >
        <SearchIcon size={20} />
        <input
